...
<div class="container" id="content">
    <img src="static/img/team1.jpg" style="float: left;">
    <div class="row">
        <div class="col-lg-4" align="justify">
            <h3><mark>WHO WE ARE</mark></h3><br>
            <p id="p1"><br> WE are a charity organization. the website is created to help people find their comfort at just one click and the revenue can go to the charity and trust<br> this website is developed for The Legionnaire Charity Organization. so that potential customer can buy every product they need or like<br><br><br><br><h4></mark></h4>
            </p>
        </div>
        <div class="col-lg-4" align="justify">
